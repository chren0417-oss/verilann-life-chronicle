...
choices:[
{id:'a',label:'天亮去药铺',detail:'1日 · 了解状况',days:1,follow:'天一亮你就去了苔丝的药铺。她正把一批变色前的雾根菇分装进麻袋，见你进来，头也不抬地问了一句："昨晚听见铃声了吗？"你摇头。她顿了顿："那就好。现在还没到时候。"她把一袋磨好的药粉推给你："拿去敷手。伤在指头，烂在骨头。',arc:{knowledge:2}},
]},
...
choices:[
{id:'a',label:'收下树皮',detail:'1日 · 守望者信物',days:1,follow:'你把树皮贴身收好。此后几天，林缘的猎狗见了你不再狂吠，反而夹着尾巴绕着你走。你隐约觉得，那片树皮上的灰烬徽记，比什么武器都好使——但也让你更想弄清楚，雾根林深处，到底躺着什么。',arc:{knowledge:3}},
]},
...
choices:[
{id:'a',label:'夜探林缘',detail:'1日 · 低风险',days:1,skill:'潜行',difficulty:8,follow:'你借着夜色摸到三棵老橡树前。夜雾很浓，你贴着树干蹲了半个时辰，什么都没发现。正要回身，脚下忽然传来一声极轻的、像是木头被挤动的"咯吱"声——那声音从地底传来，闷闷的，隔着一层土。你屏住呼吸听了很久，再没有动静，才一步一回头地回了村。',arc:{knowledge:4}},
]},
...
choices:[
{id:'a',label:'问苔丝',detail:'1日 · 交谈',days:1,follow:'你问苔丝"开始了吗"是什么意思。她沉默了很久，从药柜底层翻出一卷泛黄的羊皮纸，展开——上面画着一棵巨大的、根系蔓延到整片大陆的树，树根下压着一座城的轮廓。她指着图角落一行模糊的小字："雾根林……底下，埋着一座城。传说那座城的人，就是被这棵树吞掉的。"',arc:{knowledge:6}},
]},
