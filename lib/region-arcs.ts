...
{id:'mist-s0-1',arcId:M,phase:0,volume:1,chapter:0,kindName:'史诗 · 暮林卷Ⅰ · 雾起苔桥',title:'苔桥村的清晨',
premise:'秋分前十天，你踏上了苔桥村的石桥。\n\n桥是旧的，青石被千百年脚步磨得发亮，桥下那条溪叫雾溪，水不深，却终年笼着一层薄薄的、带着草木腥气的水汽。苔桥村就卧在这座桥的两岸：东岸是住家与磨坊，西岸是药铺、铁匠铺和一座小小的谷仓。村子不大，人口几百，一半靠雾根林过活——采菇、伐木、猎兽，日子过得像溪水一样平。\n\n你是外人。这在外人稀少的苔桥村是个惹眼的事。你进村那天，磨坊的老汉在桥头打量了你半晌，问你是做什么的。你说路过。老汉没再问，只是指着西岸那棵最大的橡树说：\"找活干就去谷仓找苔丝，她是这村里最闲不下来的一个。\"\n\n你住了下来。起初只是帮谷仓搬两袋粮、替铁匠拉两下风箱，换一顿热饭和一角屋檐。苔丝是个三十出头的女人，头发用木簪随意绾着，说话又快又直。她打量了你几眼，丢给你一截捆药的麻绳：\"雾根林边缘的雾根菇，认得不？认得就去采。采满一篓给三十铜，比搬粮划算。\"\n\n你于是学着苔桥村人的样子，天不亮就背着竹篓进雾根林。林子在村北，顺着雾溪往上走两刻钟就到了。边缘的树不密，阳光还能漏下来，地上铺着厚厚的落叶，踩上去窸窣作响。雾根菇就长在老橡树的根部，一簇一簇，伞盖银灰色，边缘卷着，清晨挂着露水。你按苔丝说的法子，用小刀从根部平着割，不伤菌丝。\n\n头几天平安无事。林子里有鸟叫，有松鼠，偶尔还能看见鹿的影子一闪而过。你采的雾根菇在村口铺开晾晒，苔丝捏起来闻了闻，点点头，把铜子数给你。\n\n那几天你慢慢摸清了苔桥村的脾性：这里的人不排外，也不热络，像雾根林本身——你只要不越界，它待你客客气气；你若越界，它有的是办法让你记住教训。\n\n可你心里一直记着桥头老汉那句话。他说这话时，眼睛望着雾根林的方向，声音低下去：\"苔桥村是好地方。就是林子……林子这两年，有点不对。\"\n\n你当时没往心里去。现在想来，那是苔桥村给你的第一个警告，只是你听不懂。\n\n秋分前第八天，你照例进林采菇。走到林缘那三棵老橡树底下时，你忽然觉得哪里不对——\n\n太静了。\n\n鸟不叫了，虫不鸣了，连风都停了。整片林缘像被人按住了咽喉，静得能听见自己的心跳。你蹲下来，看见你脚边那株雾根菇的伞盖上，沾着一滴暗紫色的黏液。\n\n那黏液不是露水。露水是清的，这滴是浊的，像从很深的地底翻上来的东西，带着一股你从未闻过的、腐甜的菌香。\n\n你伸手碰了碰那滴黏液，指尖传来一阵细微的、像是针扎的凉意。\n\n你抬头。雾根林深处，雾不知什么时候浓了起来，白得像奶，沉甸甸地压着树冠。你隐约觉得，雾里有东西在看你也看你。\n\n你背起竹篓往回走，走得比平时快。回村的路上，你迎面碰见苔丝。她看了你一眼，又看了你一眼，脸色忽然变了：\"你碰了什么？\"\n\n你低头，看见自己指尖上那点暗紫色，已经渗进皮肤，洗不掉了。\n\n苔丝没说话，拉着你快步回了药铺。她打了一盆清水，把一撮晒干的草药丢进去，抓过你的手按在药汤里。那药汤起了一层细泡，泛着浑浊的青。\n\n\"这是雾根菇的浆。\"苔丝盯着你的指尖，声音压得很低，\"正常的雾根菇，浆是银白色的，见风就干。只有……\"\n\n她没把话说完。她松开你的手，走到药柜前站了很久，久到你以为她忘了你在。\n\n最后她转过身，眼神复杂地看着你：\"秋分前七天，雾根菇开始变色的事，会传遍苔桥村的。你既然沾上了，就走不开了。\"\n\n那天晚上，你躺在谷仓的干草堆上，翻来覆去睡不着。指尖那股凉意已经退了，但腐甜的菌香，似乎一直若有若无地跟着你。\n\n你不知道那是什么。你只知道，从明天起，苔桥村要出事了。',
flags:[],
condition:s=>s.region===5&&arcOf(s,M).phase===0&&!arcSeen(s,M,'mist-s0-1')&&!arcOf(s,M).flags['mist-saga'],
choices:[
{flag:'mist-s0-1',id:'a',label:'天亮去药铺',detail:'1日 · 了解状况',days:1,follow:'天一亮你就去了苔丝的药铺。她正把一批变色前的雾根菇分装进麻袋，见你进来，头也不抬地问了一句："昨晚听见铃声了吗？"你摇头。她顿了顿："那就好。现在还没到时候。"她把一袋磨好的药粉推给你："拿去敷手。伤在指头，烂在骨头。',arc:{knowledge:2}},
]},
{id:'mist-s0-2',arcId:M,phase:0,volume:1,chapter:0,kindName:'史诗 · 暮林卷Ⅰ · 雾起苔桥',title:'灰枝守望者',
premise:'艾琳·雾语是第三天傍晚到的。\n\n她到的时候没有惊动任何人。你正从谷仓出来，迎面看见桥头站着一个披灰绿色斗篷的女人，腰间挂着一柄没有鞘的短刀，正望着雾根林的方向出神。夕阳把她的影子拉得很长，横过整座石桥。\n\n苔丝从药铺里出来，看见她，脚步顿了一下，然后走过去："艾琳。"\n\n\"苔丝。\"艾琳转过头。她的脸被斗篷帽檐遮去一半，露出的下巴轮廓很硬，声音却出乎意料地轻，"蘑菇什么时候变的色？"\n\n\"前七天。"苔丝答得很快，"先是林缘的三棵老橡树根上，后来整片西坡都见了。我让村里人别碰了，药铺也停了收。\"\n\n艾琳点点头，又问："林里有没有动物尸体？"\n\n\"没有。\"苔丝说，"活物倒是少了。守夜的猎狗这几天一直对着林缘叫，拽都拽不住。\"\n\n\"夜里有没有听到铃声？\"\n\n苔丝沉默了一会儿："听到了。前天夜里，响了大半夜。\"\n\n艾琳没有再问。她沿着桥走了半圈，在桥尾停下，蹲下身，用刀尖挑起桥缝里一撮发黑的东西。那东西在你看来只是泥，但艾琳捻了捻，忽然站起来，脸色沉了下去。\n\n\"从今天起，雾根林边缘的采集，先停了吧。\"她说。\n\n苔丝嘴唇动了动，想说什么，最终只是点了点头。\n\n那天夜里，艾琳在谷仓门口找到你。你正在给守夜的猎狗添食，她站在阴影里，开口就问："你碰过那黏液？"\n\n你摊开手。指尖的暗紫色已经淡了，但还在。\n\n艾琳看着你的手，半晌，从怀里摸出一小片干枯的树皮递给你："灰枝守望者欠你一次人情。这东西贴身收着，雾根林里的东西，认得这个味儿。"\n\n你没问"灰枝守望者"是什么。但她走远以后，你借着月光看那片树皮——它表面刻着一枚被树根缠绕的灰烬徽记，纹路很浅，像是刻了千年。\n\n你不知道的是，就在你看着树皮的同一刻，雾根林深处，那三棵老橡树底下的土层，忽然轻微地起伏了一下。\n\n像有什么巨大的东西，在土里翻了个身。',
flags:[],
condition:s=>s.region===5&&arcSeen(s,M,'mist-s0-1')&&!arcSeen(s,M,'mist-s0-2')&&!arcOf(s,M).flags['mist-saga'],
choices:[
{flag:'mist-s0-2',id:'a',label:'收下树皮',detail:'1日 · 守望者信物',days:1,follow:'你把树皮贴身收好。此后几天，林缘的猎狗见了你不再狂吠，反而夹着尾巴绕着你走。你隐约觉得，那片树皮上的灰烬徽记，比什么武器都好使——但也让你更想弄清楚，雾根林深处，到底躺着什么。',arc:{knowledge:3}},
]},
{id:'mist-s0-3',arcId:M,phase:0,volume:1,chapter:0,kindName:'史诗 · 暮林卷Ⅰ · 雾起苔桥',title:'药铺的账本',
premise:'苔丝的药铺在西岸，门脸不大，柜台上常年摊着一本翻得起了毛边的账本。\n\n你第一次注意到那本账本，是因为苔丝翻它的频率高得不正常。变色的事传开以后，她每天都要把那本账本从头翻到尾好几遍，眉头越皱越紧。\n\n那天傍晚，你替她把晾干的草药收回柜里，随口问了一句："账不对？"\n\n苔丝手顿了一下。她把账本往你面前推了推，指着其中几页："你看。近三年，药铺收的雾根菇，一年比一年多——去年是前年的一倍半。村里人就这么多，用不了这么多药。\"\n\n你低头看。账本上，收购的数目确实年年翻，买家的名字却越来越集中，到最后几乎只剩下一个："公会"。\n\n\"药剂师公会的人，每年秋分前来收一批，给的价一年比一年高。\"苔丝说，"高到我都不敢信。可他们的马车从来不进村，只在桥头交货，连水都不喝一口。\"\n\n她合上账本，望着窗外雾根林的方向，声音很轻：\"我采了三十年的雾根菇，从没见过有人这么想要它们。\"\n\n你没接话。但你心里记下了：苔桥村的雾根菇，有人在大量收购，收了三年。\n\n第二天，你在桥头碰见磨坊的老汉。他正蹲在桥墩边抽旱烟，见你过来，朝你招招手，压低声音说：\"小子，你是个外人，外人有外人的好处——苔桥村的事，你看得比我们清楚。\"\n\n他磕了磕烟灰，指了指雾根林：\"那片林子，我爷爷那辈就说过，底下埋着东西。老辈人说是古时候的遗迹，也有人说是一座城。\"\n\n\"后来呢？\"你问。\n\n\"后来没人记得了。\"老汉嘿嘿笑了两声，眼神却一点笑意也没有，"只留下个规矩：雾根林不许深挖，不许点火，秋分前后不许夜行。\"\n\n他望着你，烟锅子在暮色里明明灭灭：\"可这两年，收蘑菇的人越来越多，林子里那点动静，也越来越大。\"\n\n"你说，会不会有一天，"他把烟杆往桥栏上一磕，声音低得像自言自语，"林子底下那个东西，自己醒过来？\"\n\n你没法回答他。但那天夜里，你第一次主动走到林缘，站在那三棵老橡树前，看着夜雾从树根间一丝一丝地渗出来。\n\n你想知道，那片雾底下，到底有什么。',
flags:[],
condition:s=>s.region===5&&arcSeen(s,M,'mist-s0-2')&&!arcSeen(s,M,'mist-s0-3')&&!arcOf(s,M).flags['mist-saga'],
choices:[
{flag:'mist-s0-3',id:'a',label:'夜探林缘',detail:'1日 · 低风险',days:1,skill:'潜行',difficulty:8,follow:'你借着夜色摸到三棵老橡树前。夜雾很浓，你贴着树干蹲了半个时辰，什么都没发现。正要回身，脚下忽然传来一声极轻的、像是木头被挤动的"咯吱"声——那声音从地底传来，闷闷的，隔着一层土。你屏住呼吸听了很久，再没有动静，才一步一回头地回了村。',arc:{knowledge:4}},
]},
{id:'mist-s0-4',arcId:M,phase:0,volume:1,chapter:0,kindName:'史诗 · 暮林卷Ⅰ · 雾起苔桥',title:'公会的马车',
premise:'秋分前七天，药剂师公会的马车进村了。\n\n那马车是浓绿色的，漆面新得晃眼，车辕上錾着公会的徽记——一枝缠绕着蛇的银莲花。赶车的是个精瘦的伙计，车帘掀开，下来一个圆脸的中年人，笑眯眯的，先给桥头看热闹的孩子们每人发了一枚铜子。\n\n\"摩尔。\"他自我介绍，笑得像一尊弥勒，"药剂师公会的，来收雾根菇。苔桥村的雾根菇，整个维尔兰都有名。\"\n\n苔丝站在药铺门口，没动。摩尔也不恼，踱步过去，从怀里掏出一只玻璃瓶，里面装着几株暗紫色的蘑菇——正是变色的那种。\n\n\"苔掌柜，\"摩尔把瓶子举到苔丝面前，"听说你这儿收了些变色的货？公会出三倍的价，有多少收多少。\"\n\n苔丝盯着那瓶子，半晌才说："变色的是病菇，收了做什么？"\n\n\"做药。\"摩尔笑得滴水不漏，"药性变了，说不定是新的药引子呢？公会什么都收，只要能入药。\"\n\n那天下午，摩尔把苔丝那筐变色的蘑菇尽数收走，临走时在桥头留话：\"往后凡是变色的雾根菇，苔桥村有多少，公会收多少。价钱好说。\"\n\n马车走了以后，苔丝站在药铺门口，攥着那三倍的铜子，脸色却冷得像霜。\n\n\"他骗人。\"她低声说，"药性变了的东西，公会不会收。他要的不是药——\"\n\n她没说完。她望着马车消失的方向，很久，才把铜子塞回兜里，转身进屋。\n\n那天夜里，守夜的猎狗集体对着林缘狂吠，拽都拽不住。有人听见林子里传来一种极轻的、像银铃又像骨哨的声音，一响就是大半夜。\n\n天亮时，你跟着村民走到林缘，看见三棵老橡树最粗的那棵，树皮上出现了三道平行的、深黑色的爪痕。\n\n那爪痕的间距，不像苔桥村人认识的任何一种野兽。\n\n苔丝站在人群边上，看着那爪痕，脸色白得像纸。\n\n\"开始了吗？\"她自言自语。\n\n没人回答她。雾从林子里涌出来，腐甜的菌香，比昨天又浓了一分。\n\n而你知道，这一切才刚刚开始。',
flags:[],
condition:s=>s.region===5&&arcSeen(s,M,'mist-s0-3')&&!arcSeen(s,M,'mist-s0-4')&&!arcOf(s,M).flags['mist-saga'],
choices:[
{flag:'mist-s0-4',id:'a',label:'问苔丝',detail:'1日 · 交谈',days:1,follow:'你问苔丝"开始了吗"是什么意思。她沉默了很久，从药柜底层翻出一卷泛黄的羊皮纸，展开——上面画着一棵巨大的、根系蔓延到整片大陆的树，树根下压着一座城的轮廓。她指着图角落一行模糊的小字："雾根林……底下，埋着一座城。传说那座城的人，就是被这棵树吞掉的。"',arc:{knowledge:6}},
]},
...
flags:[],
condition:s=>s.region===5&&arcOf(s,M).phase===0&&!arcOf(s,M).flags['mist-saga']&&arcSeen(s,M,'mist-s0-4')&&!arcSeen(s,M,'mist-s1'),
choices:[
...
{id:'mist-s1-5',arcId:M,phase:1,volume:1,chapter:1,kindName:'史诗 · 暮林卷Ⅰ · 雾起苔桥',title:'苔桥的夜',
premise:'那一夜，苔桥村没有人睡好。\n\n你从雾根林边缘回来时天已经黑透了。火把在夜风里晃，林子里那声闷响——像什么东西从地底翻了个身——已经过去了一个时辰，可你后颈的汗毛还是竖着的。你背上那几株变色的雾根菇用油布裹了三层，隔着布，那股腐甜的菌香仍然若有若无地往鼻子里钻。\n\n苔丝在药铺门口等你。她没点灯，站在门框的阴影里，看见你回来才从黑暗里走出来，接过油布包掂了掂。\n\n"你真的采到了。"她说，声音里听不出是喜是惊，"先别进村。绕到屋后，把东西泡在井水里。"\n\n你照做了。井水一夜之间变得浑浊，第二天清早，水面浮着一层暗紫色的沫。\n\n那一夜，你先听见的是狗叫。\n\n守夜的猎狗——苔桥村一共七条，平日里温顺得见了生人也只是摇尾巴——忽然同时狂吠起来，声音凄厉，像被什么掐住了脖子。它们对着同一个方向：雾根林。\n\n紧接着是铃声。\n\n那声音从林子里来，极轻，极远，像风穿过一串悬在枯枝上的银铃，又像有人在很深的地方，用指甲刮一根绷紧的骨弦。它一响就是大半夜，断断续续，从不间断。\n\n村里有人从窗户探出头，骂了一声"见鬼"，又缩了回去。有人披衣出来，站在自家门口，听了一会儿，又回去了。\n\n磨坊的老汉披着旧袄坐在桥头，烟锅子里的火一明一灭。你走过去，在他身边坐下。\n\n"听见了？"他问。\n\n"听见了。"你说。\n\n老汉把烟灰磕在桥栏上，半天没说话。\n\n"我爷爷那辈，也听过这铃声。"他终于开口，"那是雾根林底下那座城，在敲它的钟。"\n\n"城里还有人？"你问。\n\n"没有人。"老汉说，"是树。树在替它敲。"\n\n你没能听懂这句话。但那一夜，你躺在谷仓的干草堆上，盯着房梁，把那句话翻来覆去嚼了很久。\n\n天亮前，铃声停了。\n\n可你知道，它还会响。\n\n而且下一次，会更近。',
flags:[],
condition:s=>s.region===5&&arcOf(s,M).flags['mist-saga']&&!arcSeen(s,M,'mist-s1-5')&&!arcOf(s,M).flags['mist-k1-save']&&!arcOf(s,M).flags['mist-k1-guide']&&!arcOf(s,M).flags['mist-k1-wait'],
choices:[
{flag:'mist-s1-5',id:'a',label:'天亮了',detail:'1日 · 夜尽天明',days:1,follow:'天光从谷仓门缝漏进来时，你听见村里有人喊了一嗓子："林缘那三棵老橡树——树皮上有东西！"你披衣出门，跟着人群往林缘走。晨雾还没散尽，三棵老橡树最粗的那棵，树皮上出现了三道平行的、深黑色的爪痕——那间距，不像苔桥村人认识的任何一种野兽。',arc:{danger:4,knowledge:2}},
]},
{id:'mist-s1-6',arcId:M,phase:1,volume:1,chapter:1,kindName:'史诗 · 暮林卷Ⅰ · 雾起苔桥',title:'林缘的爪痕',
premise:'三道爪痕，在晨雾里黑得发亮。\n\n它们刻在三棵老橡树最粗的那棵上，位置齐人高，间距均匀，像用一把三指的铁耙从树皮上犁过去。边缘的树皮翻卷着，露出底下暗红色的木质——那红色太深，不像受伤的树，倒像那棵树本身的颜色就是这样。\n\n围观的村民里三层外三层，谁也不敢上前。有人伸手想摸，被身边的人一把拽住："你不要命了？"\n\n苔丝蹲在树下，看了很久，用银刀从爪痕边缘刮下一点粉末，装进瓷瓶。她起身时脸色发白，什么也没说。\n\n你注意到一件事：三道爪痕的间距，比熊掌宽，比虎爪窄，指腹的位置有细密的螺纹——像人的指纹，只是大了三倍。\n\n"这不是野兽。"你说。\n\n人群安静了一瞬。苔丝转头看你，眼神复杂。\n\n"你见过这东西？"她问。\n\n"没有。"你老老实实地说，"但我在雾根林里采过半个月的菇。野兽的爪子，不会是圆的。"\n\n苔丝沉默了一会儿。\n\n"你说得对。"她说，"这不是爪子。这是……手印。"\n\n人群炸开了锅。有人当场往后退了三步，有人喊着要去找灰枝守望者。苔丝却没动，她望着那三道爪痕，声音很轻，几乎被晨风盖住：\n\n"树根下的东西，醒了。"\n\n那天上午，消息传遍了苔桥村。\n\n有人收拾细软准备投奔邻村的亲戚，有人跑到村口磨坊借驴车。但也有人没动——苔丝没动，磨坊的老汉没动，艾琳·雾语在那天下午到了村口，披着灰绿色斗篷，站在桥头，看了一眼那三道爪痕，只说了一句话：\n\n"从今天起，雾根林，不许任何人再进。"\n\n她说完这句话，转身走到你面前，递给你一截削好的木棍。\n\n"你会用刀？"她问。\n\n你点头。\n\n"跟我走。"她说，"林缘到溪口那一段，从今天起归你巡。"\n\n你接过了那截木棍。\n\n你不知道，这一接，你就真的走不开了。',
flags:[],
condition:s=>s.region===5&&arcSeen(s,M,'mist-s1-5')&&!arcSeen(s,M,'mist-s1-6')&&!arcOf(s,M).flags['mist-k1-save']&&!arcOf(s,M).flags['mist-k1-guide']&&!arcOf(s,M).flags['mist-k1-wait'],
choices:[
{flag:'mist-s1-6',id:'a',label:'接下巡林',detail:'1日 · 巡林职责',days:1,skill:'生存',difficulty:6,follow:'你接下巡林的差事。林缘到溪口那段路，你一天走三遍，记熟了每一棵树的影子。第二天傍晚，你在溪口捡到一只水囊——牛皮缝的，底部绣着一朵小小的雾根菇。那是莉亚的。',npc:[{id:'mist-elin',affinity:6,trust:4}],arc:{knowledge:3}},
]},
{id:'mist-s1-7',arcId:M,phase:1,volume:1,chapter:1,kindName:'史诗 · 暮林卷Ⅰ · 雾起苔桥',title:'莉亚的背影',
premise:'你第一次注意到莉亚，是在她失踪前三天。\n\n那天天还没亮透，你照例去林缘巡路，远远看见一个背竹篓的身影沿着溪边往上走。那身影很瘦，步子却快，走山路像走平地，竹篓在她背上晃都不晃。\n\n"莉亚！"溪口有人喊，"今儿雾重，别往深里走了！"\n\n她回头，笑着应了一声"采完这趟就歇了"，声音脆生生的，带着点山里人特有的尾音。她没停脚，很快消失在林雾里。\n\n那是你第一次听见她的名字。\n\n后来苔丝告诉你，莉亚是她的徒弟，也是苔桥村最年轻的采药人。她五岁跟着苔丝上山认药草，十三岁就能一个人进雾根林采雾根菇，全村人都说她是"林子里长大的孩子"。\n\n"她认路的本事，比狗都灵。"苔丝说这话时眼里带着笑，"雾根林她闭着眼都能走出来。"\n\n你第二次见到莉亚，是她失踪前一天。\n\n那天傍晚，你巡到林缘，看见她蹲在三棵老橡树底下——就是有爪痕的那棵——手里捏着一朵变色的雾根菇，看得入神。你走过去，她吓了一跳，站起来，脸上有一瞬间的慌乱。\n\n"你吓死我了。"她拍着胸口，又蹲下去，"你看这个。"\n\n你蹲下来。那朵蘑菇的菌褶里，嵌着一粒米粒大小的、发亮的黑色颗粒，像一颗极小的珍珠。\n\n"这不是雾根菇的东西。"莉亚说，声音压得很低，"我采了这么多年，从没见过这种籽。它像是……从地底下带上来的。"\n\n"你怎么知道是地底下带上来的？"你问。\n\n莉亚顿了一下。\n\n"我那天在旧矿道口睡了一觉。"她说，像是怕被人听见，"迷迷糊糊的，听见树根底下有人说话。说的不是人话，像……像唱歌。我醒过来，手里就攥着这颗籽。"\n\n她摊开手掌——掌心里有一道浅浅的、已经结痂的伤口，泛着不正常的青紫色。\n\n"你别告诉苔丝。"她站起来，把那颗黑色的籽收进贴身的小袋子里，"她要是知道了，就不让我进林子了。"\n\n她背着竹篓走了。你站在老橡树底下，看着她的背影消失在林雾里。\n\n第二天，她就失踪了。\n\n后来你无数次回想那个傍晚：如果当时你多说一句，如果当时你拦住她——\n\n可你什么也没说。\n\n你只是看着她走进雾里，像她走过无数次那样。',
flags:[],
condition:s=>s.region===5&&arcSeen(s,M,'mist-s1-6')&&!arcSeen(s,M,'mist-s1-7')&&!arcOf(s,M).flags['mist-k1-save']&&!arcOf(s,M).flags['mist-k1-guide']&&!arcOf(s,M).flags['mist-k1-wait'],
choices:[
{flag:'mist-s1-7',id:'a',label:'记住这个傍晚',detail:'1日 · 追忆',days:1,follow:'那个傍晚像烙铁一样印在你脑子里。第二天清早，磨坊的老汉在村口喊了一嗓子："莉亚昨儿进林子，一夜没回来！"你扔下手里的巡林木棍就往溪口跑。溪边只有一只水囊，和一截被扯断的捆药绳。绳头上沾着暗紫色的黏液——和那些变色的蘑菇，是同一个颜色。',arc:{tension:4,danger:3}},
]},
...
flags:[],
condition:s=>s.region===5&&arcOf(s,M).flags['mist-saga']&&arcOf(s,M).phase>=1&&arcSeen(s,M,'mist-s1-7')&&!arcSeen(s,M,'mist-s2'),
choices:[
